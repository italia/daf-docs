...
# -*- coding: utf-8 -*-
#
# Data & Analytics Framework - DAF documentation build configuration file, created by
...
project = 'Data & Analytics Framework - DAF'
...
#
# html_title = 'Data & Analytics Framework - DAF v0.0.1'
...
htmlhelp_basename = 'DataAnalyticsFramework-DAFdoc'
...
latex_documents = [
    (master_doc, 'DataAnalyticsFramework-DAF.tex', 'Data \\& Analytics Framework - DAF Documentation',
     'Team per la Trasformazione Digitale', 'manual'),
]
...
man_pages = [
    (master_doc, 'dataanalyticsframework-daf', 'Data & Analytics Framework - DAF Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DataAnalyticsFramework-DAF', 'Data & Analytics Framework - DAF Documentation',
     author, 'DataAnalyticsFramework-DAF', 'One line description of project.',
     'Miscellaneous'),
]
