...
To introduce the philosophy behind the DAF we have to explain the following core concepts:

-  `Dataset <dataset.html>`__ - the DAF platform revolves around the
   ...
   platform.
-  `Metadata & Schemas <dataset-metadata-schemas/index.html>`__ - to describe the
